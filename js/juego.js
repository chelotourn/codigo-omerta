...
function htmlDeclaracion(d, e) {
  ...
  return `
    <div class="${cls}">
      ...
      <div>
		  <div class="decl-id ayuda-clicable" data-carta-id="${d.carta_id}" title="Ver pista de esta carta">#${String(d.carta_id).padStart(2,'0')}</div>
      ...
      <div class="decl-cuerpo">
        <div class="decl-topbar">
          <div>
            ...
            <div class="decl-cat ayuda-clicable" data-cat-id="${d.carta_categoria}" title="Ver explicación de esta categoría">${d.carta_categoria}</div>
          </div>
