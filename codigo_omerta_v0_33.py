...
PORC_MAX_REPETICION_CARTA = 0.20  # tope hardcodeado: ninguna carta puede aparecer
...
TEXTOS_CARTAS = {
    ...
    72: "Si nadie se atreve a acusar directamente al culpable éste esta presionado. Pero los pobres no tienen nada que perder y dirán la verdad",
}
